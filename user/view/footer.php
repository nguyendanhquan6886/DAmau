         ...
         <div id="footer">
            <div class="footer-left">
              ...
              <div class="card_1">
                ...
                <div>
                  <i class="fa-sharp fa-solid fa-location-pin" style="color: red;"></i>
                  <p>
                ...
                <div>
                  <i class="fa-solid fa-phone-flip" style="color: green;"></i>
                  <p>1900.63.69.36</p>
                </div>
      
                <div>
                  <i class="fa-solid fa-envelope" style="color: #E95950;"></i>
                ...
                <div class="icons">
                  ...
                  <i class="fa-brands fa-square-instagram " style="color: #E95950;"></i>
                  <i class="fa-brands fa-youtube" style="color: red;"></i>
                  <i class="fa-brands fa-square-twitter " style="color: #1DA1F2;"></i>
                  <i class="fa-brands fa-google-plus" style="color: #FBBC05;"></i>
                </div>
