<?php
    ...
    function addpro($ten,$gia,$sale,$img,$ct,$cate){
        $sql = "insert into product(pro_name,pro_price,pro_sale,pro_img,pro_ctiet,cate_id) values('$ten',$gia,$sale,'$img','$ct',$cate)";
        pdo_execute($sql);
    }
    ...
    function updatepro($ten,$gia,$sale,$img,$ct,$cate,$id){
        $sql = "update product set pro_name='$ten',pro_price=$gia,pro_sale=$sale,pro_img='$img',pro_ctiet='$ct',cate_id=$cate where pro_id = $id";
        pdo_execute($sql);
    }
